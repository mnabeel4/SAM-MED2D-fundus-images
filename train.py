...
def parse_args():
    ...
    parser.add_argument("--work_dir", type=str, default="H:/workspace/Nabeel/SAM-Med2D", help="work dir")
    parser.add_argument("--run_name", type=str, default="sam-med2d-essex_MAEs", help="run model name")
    parser.add_argument("--epochs", type=int, default=300,help="number of epochs")
    parser.add_argument("--batch_size", type=int, default=16,help="train batch size")
    parser.add_argument("--image_size", type=int, default=256, help="image_size")
    parser.add_argument("--mask_num", type=int, default=8, help="get mask number")
    parser.add_argument("--data_path", type=str, default="H:/workspace/Nabeel/SAM-Med2D/data_demo", help="train data path")
    parser.add_argument("--metrics", nargs='+', default=['iou', 'dice'], help="metrics")
    parser.add_argument('--device', type=str, default='cuda')
    parser.add_argument("--lr", type=float, default=1e-4, help="learning rate")
    #parser.add_argument('--dropout', type=float, default=0.5, help='Dropout rate')
    #parser.add_argument('--l1', type=float, default=0.5, help='L1 regularization parameter')
    #parser.add_argument('--l2', type=float, default=0.6, help='L2 regularization parameter')
    parser.add_argument("--resume", type=str, default=None, help="load resume")
    parser.add_argument("--model_type", type=str, default="vit_b", help="sam model_type")
    parser.add_argument("--sam_checkpoint", type=str, default="H:/workspace/Nabeel/SAM-Med2D-main (2)/SAM-Med2D-main/models/sam-med2d_b.pth", help="sam checkpoint")
