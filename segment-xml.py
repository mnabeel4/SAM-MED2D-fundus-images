...
#This function is used to retrieve the folder name, filename, boudary boxes information.
...
#This function is used to convert the masks segmentation into voc annotations.
...
# Example usage to load the input images and save the output directory

input_folder = "H:/workspace/Nabeel/SAM-Med2D/data_demo/masks"
output_folder = "H:/workspace/Nabeel/SAM-Med2D/data_demo/voc_xml"
